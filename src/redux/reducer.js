const reducer = (oldState, action) => {
  ...
  switch (action.type) {
    ...
    case "SHOW_FRUIT_TASTE":
      return {
        ...
        fruits: {
          ...
          single_fruit: {
            ...oldState.fruits.single_fruit,
            fruit_taste: !oldState.fruits.single_fruit.fruit_taste,
            fruit_grow: false,
            desc: false,
            fruit_nutrition: false
          }
      ...
      return {
        ...
        fruits: {
          ...
          single_fruit: {
            ...oldState.fruits.single_fruit,
            fruit_taste: false,
            fruit_grow: !oldState.fruits.single_fruit.fruit_grow,
            desc: false,
            fruit_nutrition: false
          }
        }
      ...
      return {
        ...
        fruits: {
          ...
          single_fruit: {
            ...
            fruit_grow: false,
            desc: false,
            fruit_nutrition: !oldState.fruits.single_fruit.fruit_nutrition
          }
        }
      };
    ...
    case "ALL_VEGS":
      return {
        ...oldState,
        vegs: { ...oldState.vegs, allvegs: action.allvegs }
      };
    ...
    case "SHOW_VEG":
      return {
        ...
        vegs: {
          ...oldState.vegs,
          show_veg: !oldState.vegs.show_veg,
          active_veg: action.showVeg
        }
      };
    ...
    case "VEG_INFO":
      return {
        ...
        vegs: {
          ...oldState.vegs,
          single_veg: { ...oldState.vegs.single_veg, info: action.info }
        }
      };
    ...
    case "VEGS_VIDEOS":
      return {
        ...
        vegs: {
          ...
          single_veg: {
            ...oldState.vegs.single_veg,
            recipe_videos: action.veg_recipe,
            garden_videos: action.veg_garden
          }
        }
      };
      ...
      return {
        ...
        vegs: {
          ...
          single_veg: {
            ...
            veg_taste: false,
            veg_grow: false,
            desc: !oldState.vegs.single_veg.desc,
            veg_nutrition: false
          }
        }
      };
    ...
    case "SHOW_VEG_TASTE":
      return {
        ...
        vegs: {
          ...
          single_veg: {
            ...oldState.vegs.single_veg,
            veg_taste: !oldState.vegs.single_veg.veg_taste,
            veg_grow: false,
            desc: false,
            veg_nutrition: false
          }
      ...
      return {
        ...
        vegs: {
          ...
          single_veg: {
            ...oldState.vegs.single_veg,
            veg_taste: false,
            veg_grow: !oldState.vegs.single_veg.veg_grow,
            desc: false,
            veg_nutrition: false
          }
        }
      ...
      return {
        ...
        vegs: {
          ...
          single_veg: {
            ...
            veg_grow: false,
            desc: false,
            veg_nutrition: !oldState.vegs.single_veg.veg_nutrition
          }
        }
      };
